...
@HelixClient
@Typed(TwitchService.class)
@ApplicationScoped
class TwitchServiceHelix extends BasicTwitchService implements TwitchService {

	private static final Logger LOGGER = LoggerFactory.getLogger(TwitchServiceHelix.class);
	...
	@Inject
	TwitchServiceHelix(final TwitchAuthService twitchAuthService) {
	...
	public String getChannelIdFrom(final String channelName) throws TwitchChannelIdException {
		LOGGER.debug("{} entered getChannelIdFrom method.", TwitchServiceHelix.class.getSimpleName());
	...
	public void updateTags(final TwitchTagBatch tags) throws TwitchTagUpdateException {
		LOGGER.debug("{} entered update tags method with params {}.", TwitchServiceHelix.class.getSimpleName(), tags);
